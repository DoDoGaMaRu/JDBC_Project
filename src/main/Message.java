...
class Message {
    ...
    public static final String INPUT_SUBJECT_NAME = "\n과목이름을 입력하세요 : ";
    public static final String INPUT_DIVIDE_CLASS_NUMBER = "\n분반번호를 입력하세요 : ";
    public static final String INPUT_GRADE = "\n성적을 입력하세요 : ";
    public static final String INPUT_NEW_SUBJECT_NUMBER = "\n신청할 과목번호를 입력하세요 : ";
    public static final String INPUT_OLD_SUBJECT_NUMBER = "\n삭제할 과목번호를 입력하세요 : ";
